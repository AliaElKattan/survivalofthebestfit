...
import Machine from '~/public/game/components/pixi/ml/machine';
import Resumes from '~/public/game/components/pixi/ml/cv-list';
import Floor from '~/public/game/components/pixi/ml/floor';
import ConveyorBelt from '~/public/game/components/pixi/ml/conveyor-belt';
import Door from '~/public/game/components/pixi/door';
import ResumeUI from '~/public/game/components/interface/ui-resume/ui-resume';
import ConversationManager from '~/public/game/components/interface/ml/conversation-manager/conversation-manager.js';
import NewsFeedUI from '~/public/game/components/interface/ml/news-feed/news-feed.js';
import AlgorithmInspectorUI from '~/public/game/components/interface/ml/algorithm-inspector/algorithm-inspector.js';
import DatasetView from '~/public/game/components/interface/ml/dataset-view/dataset-view';
import ScanRay from '~/public/game/components/pixi/ml/scan-ray.js';
import DataServer from '~/public/game/components/pixi/ml/data-server.js';
import MLPeople from '~/public/game/components/pixi/ml/people.js';
import TimelineManager from '~/public/game/components/interface/ml/timeline-manager/timeline-manager';
